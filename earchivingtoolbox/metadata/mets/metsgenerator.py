...
import fnmatch
from earchivingtoolbox.storage.checksum import get_sha256_hash
from earchivingtoolbox.utils.datetime import get_file_ctime_iso_date_str, DT_ISO_FMT_SEC_PREC, current_timestamp
from earchivingtoolbox.format.formatidentification import FormatIdentification
from earchivingtoolbox.metadata.XmlHelper import q, XSI_NS
from earchivingtoolbox.settings import application_name, application_version
...
class MetsGenerator(object):
    ...
    def createMets(self, mets_data, mets_file_path=None):
        ...
        # add an agent
        mets_hdr.append(self.createAgent("CREATOR", "OTHER", "SOFTWARE", application_name, "VERSION=%s" % application_version))
