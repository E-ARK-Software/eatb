...
from earchivingtoolbox.storage.checksum import ChecksumValidation
from earchivingtoolbox.utils.fileutils import remove_protocol
from earchivingtoolbox.metadata.XmlHelper import q
